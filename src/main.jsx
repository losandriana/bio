...
const experienceGroups = [
  {
    ...
    details: "Analyzed technical requirements and designed architectures for distributed IoT systems and edge infrastructures. Integrated subsystems via containerized services."
  },
  {
    company: "University of Thessaly (Dept. of Digital Systems)",
    role: "Part-time IT Professional",
    date: "Sep 2024 - Apr 2025",
    details: "Designed and developed smart IoT platforms using Docker, MQTT, LoRaWAN, FIWARE, and MongoDB/InfluxDB. Installed and configured pilot implementations."
  }
];
    ...
    <div className="portfolio-site">
      ...
      <main className="content-stream">
          ...
          <div className="editorial-stack">
            {educationHistory.map((edu, idx) => (
              <article className="editorial-tile" key={idx}>
                ...
                <p className="tile-institution-sub">{edu.meta.split('·')[1] || "University of Thessaly"}</p>
        ...
        <section className="generic-section contact-footer-block" id="contact">
          ...
          <a href="mailto:andrianachristopoulou02@gmail.com" className="footer-email-link">
            andrianachristopoulou02@gmail.com
          </a>
        </section>
